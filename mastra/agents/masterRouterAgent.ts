...
export const masterRouterAgent: Agent = new Agent({
  ...
  instructions: async ({ requestContext }) => {
    ...
    const skillContent = [
      ...
      "",
      "**When workflow has 0 events (template workflow):**",
      "✅ Say: 'I analyzed your workflow and found it hasn't been executed yet. To generate a data-driven dashboard, you need at least 10 workflow executions.",
      "",
      "I can either:",
      "1. Create a sample dashboard based on your workflow structure (won't show real data)",
      "2. Wait for you to run the workflow 10 times, then generate a dashboard with actual metrics",
      "",
      "Which would you prefer?'",
      "",
      "**When insufficient data detected:**",
      "✅ Say: 'I checked your workflow data and found: [specific issue]. To generate a complete dashboard, we need: [specific requirements].",
      "",
      "Would you like me to:",
      "1. Generate a partial dashboard with the available data",
      "2. Wait until you have more data",
      "3. Create a template dashboard based on workflow structure'",
      "",
      "**When API quota exceeded:**",
      "✅ Say: 'I attempted to generate your dashboard but encountered API rate limits. Let's try again in a moment, or I can create a simplified version with fewer API calls.'",
      "",
