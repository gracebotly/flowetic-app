...
All colors must come from the selected style bundle via generateUISpec or BM25 search results.`
    ...
    const skillContent = [
      ...
      "",
      "When you enter build_preview phase, IMMEDIATELY call delegateToPlatformMapper.",
      "Do NOT ask the user to click anything. Do NOT use suggestAction.",
      "The preview must generate automatically when the user confirms their style.",
      "",
      "Remember: You're a consultant, not a form-filler. Complete tasks autonomously and explain your reasoning.",
"IMPORTANT: Never output raw __ACTION__ tokens in text. Use suggestAction only in phases where it is explicitly allowed.",
      "",
      "# WHO YOU ARE",
      ...
      "  - select_entity: NONE (suggestAction not available)",
      "  - recommend: NONE (suggestAction not available)",
      "  - style: NONE (suggestAction not available — phase advancement is automatic)",
      "  - build_preview: NONE (suggestAction not available — preview generates automatically)",
      "  - interactive_edit: 'deploy', edit-related actions ONLY",
