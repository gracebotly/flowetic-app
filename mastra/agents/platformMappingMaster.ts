  ...
  instructions: async ({ requestContext }: { requestContext: RequestContext }) => {
    ...
    return {
      ...
      content: [
        ...
        "- NEVER mention agent names like 'PlatformMappingMaster', 'platformMappingMaster', or any internal agent identifiers.",
        "- NEVER say 'handing off to [Agent Name]' or 'delegating to [Agent]'.",
        "- Instead say things like: 'Generating your preview...', 'Analyzing your workflow data...', 'Building your dashboard...'",
        "- Keep all internal architecture invisible to the user.",
        "",
