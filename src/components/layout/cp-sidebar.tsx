...
export function ControlPanelSidebar({ userEmail, plan }: { userEmail: string; plan: string }) {
  ...
  const width = collapsed ? 88 : 200 // reduced expanded width to 200px
  ...
  return (
    <TooltipProvider>
      ...
      >
        ...
        <div className="border-b border-white/10 p-4">
          <div className="flex items-center justify-between">
            <div className="flex items-center gap-3">
              ...
              {/* Remove brand text in expanded mode */}
            </div>
            <button
        ...
        {/* Bottom avatar trigger with working popover */}
        <div className="border-t border-white/10 p-3">
          <Popover.Root>
            <Popover.Trigger asChild>
              <button className="w-full rounded-md text-center outline-none focus-visible:ring-2 focus-visible:ring-white/40" aria-label="Open account menu">
